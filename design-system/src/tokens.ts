...
export const color = {
  ...
  statementSurface: 'var(--color-statement-surface)',
  onStatement: 'var(--color-on-statement)',
  onStatementMuted: 'var(--color-on-statement-muted)',
  statementOutline: 'var(--color-statement-outline)',
